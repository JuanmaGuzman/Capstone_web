...
export default function catalogFilter() {
    ...
    const [posts, setPosts] = useState(Array<SuccinctPublicationSchema>)
    ...
    return (
        <>
            <div className="container text-center mx-auto"> 
                <div className="row">
                    <h2 style={{marginBottom: "1%"}}>Catálogo con filtros</h2>
                </div>
                <hr/>
                <div className="row">
                    <div className="col-3">
                        <Filters filtrado={true} filtersUsed={brandfilter.concat(categoryfilter)} brands={[]} categories={[]} fromCatalog={true}/>
                    </div>
                    <div className="col-9">
                    <div className="row">
                    {
